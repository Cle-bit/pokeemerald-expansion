...
extern const u8 gText_WildDoubleon[];
extern const u8 gText_WildDoubleoff[];
extern const u8 gText_BagUseon[];
extern const u8 gText_BagUseoff[];
extern const u8 gText_Followeron[];
extern const u8 gText_Followeroff[];
extern const u8 gText_MoveDescriptionon[];
extern const u8 gText_MoveDescriptionoff[];
...
extern const u8 gText_WildDouble[];
extern const u8 gText_BagUse[];
//extern const u8 gText_Follower[];
extern const u8 gText_MoveDescription[];
