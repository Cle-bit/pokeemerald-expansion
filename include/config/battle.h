...
#define B_FLAG_DYNAMAX_BATTLE       FLAG_UNUSED_0x026     // If this flag is set, the ability to Dynamax in battle is enabled for all trainers.
...
#define B_FLAG_MOVE_DESCRIPTION     FLAG_UNUSED_0x025     // If this flag is set, pressing this button will open the move description menu.
