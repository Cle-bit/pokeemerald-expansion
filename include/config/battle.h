...
#define B_FLAG_FORCE_DOUBLE_WILD    FLAG_UNUSED_0x022     // If this flag is set, all land and surfing wild battles will be double battles.
#define B_SMART_WILD_AI_FLAG        0     // If not 0, you can set this flag in a script to enable smart wild pokemon
#define B_FLAG_NO_BAG_USE           FLAG_UNUSED_0x023     // If this flag is set, the ability to use the bag in battle is disabled.
...
#define B_FLAG_SLEEP_CLAUSE         FLAG_UNUSED_0x025     // If this flag is set, sleep clause is enabled; if the player / AI has already put a Pokémon on the opponent's side to sleep and it is still sleeping, another one can't be put to sleep. AI requires AI_FLAG_CHECK_BAD_MOVE to understand.
