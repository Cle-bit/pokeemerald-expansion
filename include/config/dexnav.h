...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_UNUSED_0x04D // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_UNUSED_0x04E // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_UNUSED_0x04F // Allow player to find hidden mons
#define DN_VAR_SPECIES                VAR_UNUSED_0x4091 // Registered DexNav species
#define DN_VAR_STEP_COUNTER           VAR_UNUSED_0x409B // Steps for finding hidden pokemon
