...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_UNUSED_0x028 // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_UNUSED_0x029 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_UNUSED_0x02A  // Allow player to find hidden mons
#define DN_VAR_SPECIES                VAR_UNUSED_0x409B // Registered DexNav species
#define DN_VAR_STEP_COUNTER           VAR_UNUSED_0x409D // Steps for finding hidden pokemon

// Search parameters
#define DEXNAV_TIMEOUT                  100  // 15 seconds is the time out. Max of 1092 seconds allowed
#define SNEAKING_PROXIMITY              100  // Tile amount
#define CREEPING_PROXIMITY              100
