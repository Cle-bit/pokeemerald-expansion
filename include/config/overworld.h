...
#define B_FLAG_FOLLOWERS_DISABLED      FLAG_UNUSED_0x04D          // Enables / Disables followers by using a flag. Helpful to disable followers for a period of time.
...
//Time
#define OW_TIMES_OF_DAY                 GEN_6_ORAS // Different generations have the times of day change at different times.
...
#define OW_FLAG_NO_COLLISION        FLAG_UNUSED_0x023  // If this flag is set, the player will be able to walk over tiles with collision. Mainly intended for debugging purposes.
#define OW_FLAG_POKE_RIDER          FLAG_UNUSED_0x024  // If this flag is set, the player will be able to use fly from the Pokenav Region Map and the Town Map key item by pressing 'R' on a city/location they are able to fly to.
...
//Option Menu
#define VAR_QUICK_BATTLE_RUN        VAR_UNUSED_0x407C
#define VAR_R_BUTTON_MODE           VAR_UNUSED_0x407D
#define VAR_BW_IVEV_DISPLAY         VAR_UNUSED_0x407E
