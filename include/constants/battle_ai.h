...
#define AI_FLAG_BASIC_TRAINER_RISKY         (AI_FLAG_BASIC_TRAINER | AI_FLAG_RISKY)
#define AI_FLAG_BASIC_TRAINER_CONSERVATIVE  (AI_FLAG_BASIC_TRAINER | AI_FLAG_CONSERVATIVE)
#define AI_FLAG_BASIC_TRAINER_DEFEND        (AI_FLAG_BASIC_TRAINER | AI_FLAG_STALL)
#define AI_FLAG_BASIC_TRAINER_POWERSTAGE     (AI_FLAG_BASIC_TRAINER | AI_FLAG_POWERFUL_STATUS)
#define AI_FLAG_BASIC_TRAINER_STRENGTHEN    (AI_FLAG_BASIC_TRAINER | AI_FLAG_PREFER_STATUS_MOVES | AI_FLAG_PREFER_BATON_PASS)

#define AI_FLAG_SMART_TRAINER               (AI_FLAG_BASIC_TRAINER | AI_FLAG_OMNISCIENT | AI_FLAG_SMART_SWITCHING | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_HP_AWARE)//else
#define AI_FLAG_SMART_TRAINER_RISKY         (AI_FLAG_SMART_TRAINER | AI_FLAG_RISKY)//HighRiskHighReturn
#define AI_FLAG_SMART_TRAINER_CONSERVATIVE  (AI_FLAG_SMART_TRAINER | AI_FLAG_CONSERVATIVE)//Endurance && WeakeningTheFoe
#define AI_FLAG_SMART_TRAINER_DEFEND        (AI_FLAG_SMART_TRAINER | AI_FLAG_STALL)//SlowAndSteady
#define AI_FLAG_SMART_TRAINER_POWERSTAGE    (AI_FLAG_SMART_TRAINER | AI_FLAG_POWERFUL_STATUS)//DependsOnTheBattlesFlow
#define AI_FLAG_SMART_TRAINER_STRENGTHEN    (AI_FLAG_SMART_TRAINER | AI_FLAG_PREFER_STATUS_MOVES | AI_FLAG_PREFER_BATON_PASS)//TotalPreparation
