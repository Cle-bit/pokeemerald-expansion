...
#define AI_FLAG_BASIC_TRAINER_RISKY1        (AI_FLAG_BASIC_TRAINER | AI_FLAG_RISKY)
#define AI_FLAG_BASIC_TRAINER_RISKY2        (AI_FLAG_BASIC_TRAINER | AI_FLAG_PREFER_HIGHEST_DAMAGE_MOVE)
...
#define AI_FLAG_SMART_TRAINER_RISKY1        (AI_FLAG_SMART_TRAINER | AI_FLAG_RISKY)//HighRiskHighReturn
#define AI_FLAG_SMART_TRAINER_RISKY2        (AI_FLAG_SMART_TRAINER | AI_FLAG_PREFER_HIGHEST_DAMAGE_MOVE)//HighRiskHighReturn
