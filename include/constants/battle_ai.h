...
#define AI_FLAG_BASIC_TRAINER_STRENGTHEN    (AI_FLAG_BASIC_TRAINER | AI_FLAG_PREFER_STATUS_MOVES)
...
#define AI_FLAG_SMART_TRAINER_STRENGTHEN    (AI_FLAG_SMART_TRAINER | AI_FLAG_PREFER_STATUS_MOVES)//TotalPreparation
