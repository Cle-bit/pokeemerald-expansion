...
void CreateBoxMon(struct BoxPokemon *boxMon, u16 species, u8 level, u8 fixedIV, u8 hasFixedPersonality, u32 fixedPersonality, u8 otIdType, u32 fixedOtId)
{
    ...
    {
        SetBoxMonData(boxMon, MON_DATA_HP_IV, &(perfectIV));
        SetBoxMonData(boxMon, MON_DATA_ATK_IV, &(perfectIV));
        SetBoxMonData(boxMon, MON_DATA_DEF_IV, &(perfectIV));
        SetBoxMonData(boxMon, MON_DATA_SPEED_IV, &(perfectIV));
        SetBoxMonData(boxMon, MON_DATA_SPATK_IV, &(perfectIV));
        SetBoxMonData(boxMon, MON_DATA_SPDEF_IV, &(perfectIV));
    }
    else
    {
