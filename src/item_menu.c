...
static const u16 sItemsByType[ITEMS_COUNT] =
{
    ...
    [ITEM_RETRO_MAIL] = ITEM_TYPE_MAIL,
        ...
        [ITEM_GALARICA_TWIG] = ITEM_TYPE_EVOLUTION_ITEM,
        ...
        [ITEM_ARMORITE_ORE] = ITEM_TYPE_SELLABLE,
        [ITEM_DYNITE_ORE] = ITEM_TYPE_SELLABLE,
        [ITEM_STRANGE_SOUVENIR] = ITEM_TYPE_SELLABLE,
        [ITEM_POKE_TOY] = ITEM_TYPE_SELLABLE,
        ...
        [ITEM_RED_SCARF] = ITEM_TYPE_SCARF,
        [ITEM_BLUE_SCARF] = ITEM_TYPE_SCARF,
        [ITEM_PINK_SCARF] = ITEM_TYPE_SCARF,
        [ITEM_GREEN_SCARF] = ITEM_TYPE_SCARF,
        [ITEM_YELLOW_SCARF] = ITEM_TYPE_SCARF,
