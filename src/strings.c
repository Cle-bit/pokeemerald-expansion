...
const u8 gText_WinStreakAdd1[] = _("+ 1 WinStreak");
const u8 gText_WinStreakAdd10[] = _("+ 10 WinStreak");
const u8 gText_WinStreakAdd50[] = _("+ 50 WinStreak");
...
const u8 gText_StatEditor[] = _("{COLOR GREEN}EDIT STATS");
